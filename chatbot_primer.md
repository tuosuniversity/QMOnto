...
qm:AestheticResolution a owl:Class ;
...
qm:BiologicalOverrideSystem a owl:Class ;
...
qm:CognitiveEmotionalPatternInheritance a owl:Class ;
...
qm:CognitiveOverwhelm a owl:Class ;
...
qm:ConstructiveInterference a owl:Class ;
...
qm:DimensionalAttunement a owl:Class ;
...
qm:EmotionalQuantumEntanglement a owl:Class ;
...
qm:ExecutiveFunctionTraining a owl:Class ;
...
qm:HistoricalImprint a owl:Class ;
...
qm:IncompleteProcessTension a owl:Class ;
...
qm:InternalCartography a owl:Class ;
...
qm:ManagementOfCognitiveStrain a owl:Class ;
...
qm:NonMaterialPhenomenon a owl:Class ;
...
qm:OntologicalReassignment a owl:Class ;
...
qm:PerceptualMastery a owl:Class ;
...
qm:ProbabilisticSteering a owl:Class ;
...
qm:PurposeRedefinition a owl:Class ;
...
qm:RecognitionPhase a owl:Class ;
...
qm:SelfAsDynamicObserverParticipant a owl:Class ;
...
qm:StructuralIntrospection a owl:Class ;
...
qm:TraumaticCollapse a owl:Class ;
...
qm:connection_Pd1_Pd6 a owl:ObjectProperty ;
...
qm:connection_Pd4_Pd6 a owl:ObjectProperty ;
...
qm:connection_Pd7_Pd10 a owl:ObjectProperty ;
...
qm:follows a owl:ObjectProperty,
...
qm:ActiveConstitutiveForceView a owl:Class ;
...
qm:DysfunctionalPattern a owl:Class ;
...
qm:Keter a owl:NamedIndividual ;
...
qm:OntologicalFirewall a owl:Class ;
...
qm:PersonalTendency_CognitiveResponsiveness a owl:Class ;
...
qm:ProbabilisticField a owl:Class ;
...
qm:SomaticLiteracy a owl:Class ;
...
qm:VolitionalContinuity a owl:Class ;
...
qm:contrastsWith a owl:ObjectProperty ;
...
qm:hasConstraint a owl:ObjectProperty ;
...
qm:interferesWith a owl:ObjectProperty ;
...
qm:isLiberatedBy a owl:ObjectProperty ;
...
qm:modifies a owl:ObjectProperty ;
...
qm:mutuallyInfluences a owl:ObjectProperty,
...
qm:performs a owl:ObjectProperty ;
...
qm:AestheticPrinciple a owl:Class ;
...
qm:AnalyticalReasoning a owl:Class ;
    rdfs:label "Analytical and Dialectical Reasoning"@en ;
    rdfs:subClassOf qm:ProcessingMechanism .

qm:AverageValenceOfPriorState a owl:Class ;
    rdfs:label "Average Valence of Prior State (AvgValence(S_t-1))",
        "Average Valence of Prior State (AvgValence(S_t-1))"@en ;
...
qm:CognitiveFramework a owl:Class ;
    rdfs:label "Cognitive Framework"@en ;
    rdfs:subClassOf qm:OtherKeyConcepts .

qm:CognitiveInfluence a owl:Class,
        owl:NamedIndividual ;
    rdfs:label "Cognitive Influence (ICj)",
        "Cognitive Influence (ICj)"@en ;
    rdfs:comment "Represents the direct impact of the overall Cognitive Appraisal (C) on the activation of a dimension."@en,
...
qm:CognitiveStructuringApproaches a owl:Class ;
    rdfs:label "Cognitive Structuring Approaches"@en ;
    rdfs:subClassOf qm:CognitiveOptimization .

qm:ConsciousnessRefinement a owl:Class ;
...
qm:EmergentPropertiesCategory a owl:Class ;
...
qm:EmotionalOpenness a owl:Class ;
...
qm:EmpiricalAbsence a owl:Class ;
...
qm:EngagementStyle a owl:Class ;
    rdfs:label "Engagement Style"@en ;
    rdfs:subClassOf qm:AdvancedPracticesAndMethodologiesCategory .

qm:FrameworkPrinciple a owl:Class ;
...
qm:FrameworkPrinciplesCategory a owl:Class ;
...
qm:HumanCapacitiesCategory a owl:Class ;
...
qm:InferentialEpistemology a owl:Class ;
...
qm:InherentDisposition a owl:Class ;
    rdfs:label "Inherent Disposition (Bias_M1)",
        "Inherent Disposition (Bias_M1)"@en ;
...
qm:IntentionalCollapse a owl:Class ;
    ...
    rdfs:subClassOf [ a owl:Restriction ;
        ...
        qm:CognitiveProcess,
        qm:CollapseMode ;
    skos:altLabel "Intentional Collapse Direction",
        "Volitional State Collapsing"@en .

qm:InterferencePattern a owl:Class ;
...
qm:IntuitiveCognition a owl:Class ;
    rdfs:label "Intuitive Cognition"@en ;
    rdfs:subClassOf qm:ProcessingMechanism .

qm:LiberationProcess a owl:Class ;
    rdfs:label "Liberation Process"@en ;
    rdfs:comment "A sophisticated methodology for identifying, understanding, and transcending the limiting influence of Inherited Scripts."@en ;
    rdfs:subClassOf [ a owl:Restriction ;
            owl:onProperty qm:hasPhase ;
            owl:someValuesFrom qm:LiberationPhase ],
        qm:InheritedScripts .

qm:MindfulnessApproachesComparisonCategory a owl:Class ;
...
qm:MindfulnessIntervention a owl:Class ;
...
qm:Observation a owl:Class ;
    rdfs:label "Observation (Ψ)",
        "Observation (Ψ)"@en ;
    rdfs:comment "The pivotal 'central trigger' or initial 'Cognitive Measurement' that instigates the psychodynamic process. It is a complex perception formed by the synergistic, multiplicative interplay of its four components. It marks the first active step in the 'Observer-Participant' dynamic."@en,
    ...
    rdfs:subClassOf [ a owl:Restriction ;
            owl:onProperty qm:composedOf ;
            owl:someValuesFrom qm:ObservationComponent ],
        [ a owl:Restriction ;
...
qm:ObserverRole a owl:Class ;
    rdfs:label "Observer Role"@en ;
    rdfs:subClassOf qm:ObserverParticipantDynamic .

qm:OverallMentalState a owl:Class ;
    rdfs:label "Overall Mental State (S)",
        "Overall Mental State (S)"@en ;
...
qm:PatternedPresence a owl:Class ;
...
qm:PerceivedLimitation a owl:Class ;
...
qm:PersonalTendency_MoodPersistence a owl:Class ;
    rdfs:label "Personal Tendency (Mood Persistence - wS)",
        "Personal Tendency (Mood Persistence - wS)"@en ;
    rdfs:subClassOf qm:PersonalTendency .

qm:PersonalTendency_Reactivity a owl:Class ;
    rdfs:label "Personal Tendency (Reactivity - wΨ)",
        "Personal Tendency (Reactivity to New Events - wΨ)"@en ;
    rdfs:subClassOf qm:PersonalTendency .

qm:PracticalLimitationsOfQMApplication a owl:Class ;
...
qm:PsychoFoundationalEncoding a owl:Class ;
...
qm:PsychoMotivationalMomentum a owl:Class ;
...
qm:PsychologicalStructure a owl:Class ;
...
qm:PurePotentiality a owl:Class ;
    rdfs:label "Pure Potentiality"@en ;
    rdfs:subClassOf qm:PsychoVolitionalDimension .

qm:SharedReality a owl:Class ;
...
qm:SigmoidFunction a owl:Class,
        owl:NamedIndividual ;
    rdfs:label "Sigmoid Function",
        "Sigmoid Function"@en ;
    rdfs:comment "A mathematical function used to transform the raw Dimensional Activation (Kj) into a normalized Final Intensity (xj) between 0 and 1. It is chosen for its non-linearity and threshold-like behavior, which mirrors psychological phenomena."@en,
...
qm:StandardizedProtocol a owl:Class ;
    rdfs:label "Standardized Protocol"@en ;
    rdfs:subClassOf qm:AdvancedPracticesAndMethodologiesCategory .

qm:SuperpositionalCognitiveEngineering a owl:Class ;
...
qm:SustainedAction a owl:Class ;
...
qm:ViewOfPerception a owl:Class ;
...
qm:canDurablyAlter a owl:ObjectProperty ;
...
qm:contributesTo a owl:ObjectProperty ;
    rdfs:label "contributes to"@en ;
    rdfs:domain qm:PsychoMeditativeDimension .

qm:definesRoleOfObserverAs a owl:ObjectProperty ;
...
qm:hasEngagementStyle a owl:ObjectProperty ;
...
qm:hasViewOfPerception a owl:ObjectProperty ;
...
qm:informs a owl:ObjectProperty ;
...
qm:isAchievedThrough a owl:ObjectProperty ;
    rdfs:label "is achieved through"@en .

qm:isBalancedBy a owl:ObjectProperty,
        owl:SymmetricProperty ;
...
qm:isDevelopedBy a owl:ObjectProperty ;
    rdfs:label "is developed by"@en .

qm:isInputTo a owl:ObjectProperty ;
    rdfs:label "is input to"@en .

qm:isMediatedBy a owl:ObjectProperty ;
...
qm:isOutputOf a owl:ObjectProperty ;
    rdfs:label "is output of"@en .

qm:isRegulatedBy a owl:ObjectProperty ;
...
qm:isSegregatedBy a owl:ObjectProperty ;
...
qm:isSubjectTo a owl:ObjectProperty ;
...
qm:receivesInputFrom a owl:ObjectProperty ;
    rdfs:label "receives input from"@en ;
    rdfs:domain qm:PsychoMeditativeDimension ;
    rdfs:range qm:PsychoConceptiveDimension .

qm:shapes a owl:ObjectProperty ;
...
qm:stemsFrom a owl:ObjectProperty ;
    rdfs:label "stems from"@en .

qm:CognitiveAnchoringFailureConsequence a owl:Class ;
...
qm:CognitiveAppraisalBias a owl:Class ;
...
qm:CognitiveModality a owl:Class ;
    rdfs:label "Cognitive Modality"@en ;
    rdfs:subClassOf qm:CognitiveFramework .

qm:CollapseDysfunction a owl:Class ;
    rdfs:label "Collapse Dysfunction"@en ;
    rdfs:subClassOf qm:PsychologicalDisharmony .

qm:CollapseMode a owl:Class ;
    rdfs:label "Collapse Mode"@en ;
    rdfs:subClassOf qm:CognitiveSuperposition .

qm:ConditioningMechanism a owl:Class ;
...
qm:ConsciousAttention a owl:Class ;
    ...
    rdfs:subClassOf qm:AdvancedPracticesAndMethodologiesCategory ;
    skos:altLabel "Cognitive Measurement",
        "Collapse Vector",
...
qm:CultivationMethod a owl:Class ;
...
qm:DestructiveInterference a owl:Class ;
...
qm:FinalIntensity a owl:Class ;
    rdfs:label "Final Intensity (xj)",
        "Final Intensity (xj)"@en ;
    ...
    rdfs:subClassOf [ a owl:Restriction ;
        ...
        [ a owl:Restriction ;
            owl:hasValue "Sigmoid Function" ;
            owl:onProperty qm:isTransformedUsing ],
        qm:ActualizationProcess,
        qm:FormalArchitecturalParameter,
        "Psychodynamic Model"@en .

qm:ObserverParticipantTheory a owl:Class ;
...
qm:OntologicalMisalignment a owl:Class ;
...
qm:Pd9 a owl:NamedIndividual,
        qm:PsychoFoundationalDimension ;
    rdfs:label "The Psycho-Foundational Dimension (Pd9)"@en ;
    qm:consolidates [ a qm:Memory ] ;
    qm:constituentOf qm:M2,
        qm:TheTransitionalModalities ;
    qm:contains [ a qm:SubconsciousInfrastructure ] ;
    qm:generates [ a qm:VulnerabilityStructure ] ;
    qm:operatesThrough [ a qm:PsychoFoundationalEncoding ] ;
    qm:servesAs [ a qm:GroundingFunction ] .

qm:PracticesCategory a owl:Class ;
    rdfs:label "Practices"@en ;
    rdfs:comment "Specific methods or exercises undertaken to apply Quantum Mindfulness principles."@en ;
    rdfs:subClassOf qm:AdvancedPracticesAndMethodologiesCategory .

qm:PsychodynamicDimensionsCategory a owl:Class ;
...
qm:PsychodynamicHarmonicAlignment a owl:Class ;
...
qm:SecondaryModalityCategory a owl:Class ;
...
qm:SustainedActionMechanism a owl:Class ;
...
qm:TheTransitionalModalities a owl:NamedIndividual,
...
qm:TraitVariable a owl:Class ;
    rdfs:label "Trait Variable (Tj)",
        "Trait Variable (Tj)"@en ;
...
qm:isAlteredBy a owl:ObjectProperty ;
    rdfs:label "is altered by"@en .

qm:isCultivatedBy a owl:ObjectProperty ;
...
qm:isSourceOf a owl:ObjectProperty ;
    rdfs:label "is source of"@en ;
    rdfs:domain qm:PsychoVolitionalDimension .

qm:isTransformedUsing a owl:ObjectProperty ;
...
qm:CognitiveAnchoring a owl:Class ;
...
qm:CognitiveAnchoringComponent a owl:Class ;
...
qm:CognitiveAppraisalComponent a owl:Class ;
    rdfs:label "Cognitive Appraisal Component"@en,
        "X. Cognitive Appraisal Component"@en ;
...
qm:CognitiveOptimization a owl:Class ;
    rdfs:label "Cognitive Optimization and Refinement"@en ;
    rdfs:subClassOf qm:AdvancedPractice .

qm:CognitiveProcess a owl:Class ;
    rdfs:label "Cognitive Process"@en ;
    rdfs:subClassOf qm:FormalArchitectureCategory .

qm:ConsciousAwareness a owl:Class ;
...
qm:ExperiencedReality a owl:Class ;
...
qm:InheritedScripts a owl:Class ;
...
qm:ProtectivePrinciple a owl:Class ;
...
qm:SubconsciousInfrastructure a owl:Class ;
...
qm:emergesFromInteractionOf a owl:ObjectProperty ;
...
qm:enables a owl:ObjectProperty ;
...
qm:operatesThrough a owl:ObjectProperty ;
    rdfs:label "operates through"@en ;
    rdfs:domain qm:PsychodynamicDimension ;
    rdfs:range qm:ProcessingMechanism .

qm:providesFoundationFor a owl:ObjectProperty ;
    rdfs:label "provides foundation for"@en ;
    rdfs:domain qm:PsychodynamicDimension ;
    rdfs:range qm:PsychodynamicDimension .

qm:ChallengesAndLimitations a owl:Class ;
...
qm:CognitiveSuperposition a owl:Class ;
...
qm:ExternalInfluence a owl:Class ;
...
qm:FormalArchitecturalParameter a owl:Class ;
    rdfs:label "Formal Architectural Parameter"@en ;
    rdfs:comment "A parameter within the formal architectural model of psychodynamic states."@en ;
    rdfs:subClassOf qm:FormalArchitectureCategory .

qm:ObservationComponent a owl:Class ;
    rdfs:label "Observation Component"@en,
        "X. Observation Component"@en ;
    rdfs:comment "A contributing factor that synergistically forms a complex Observation (Ψ)."@en ;
    rdfs:subClassOf qm:ObservationComponentsCategory .

qm:ObserverParticipantDynamic a owl:Class ;
    rdfs:label "Observer-Participant Dynamic"@en ;
    rdfs:subClassOf qm:ObserverParticipantTheory .

qm:OtherKeyConcepts a owl:Class ;
...
qm:Pd5 a owl:NamedIndividual,
        qm:PsychoProtectiveDimension ;
    rdfs:label "The Psycho-Protective Dimension (Pd5)"@en ;
    qm:constituentOf qm:M2 ;
    qm:embodiesPrinciple [ a qm:PrincipleOfMeasure ],
        [ a qm:PrincipleOfLimit ],
        [ a qm:PrincipleOfRestraint ] ;
    qm:influences qm:Pd8 ;
    qm:isArchitectOf [ a qm:PsychologicalStructure ] ;
    qm:isMediatedBy qm:Pd6 ;
    qm:underpins [ a qm:SelfIntegrity ] .

qm:Pd6 a owl:NamedIndividual,
        qm:PsychoAestheticDimension ;
    rdfs:label "The Psycho-Aesthetic Dimension (Pd6)"@en ;
    qm:bridgesTo qm:Pd7 ;
    qm:constituentOf qm:M2 ;
    qm:embodiesPrinciple [ a qm:PrincipleOfBalance ],
        [ a qm:PrincipleOfSymmetry ] ;
    qm:functionsAs [ a qm:PsychologicalHeart ] ;
    qm:hasKabbalisticCorrespondence qm:Tiferet ;
    qm:isKeyTo [ a qm:PsychodynamicHarmonicAlignment ] .

qm:Pd8 a owl:NamedIndividual,
        qm:PsychoReceptiveDimension ;
    rdfs:label "The Psycho-Receptive Dimension (Pd8)"@en ;
    qm:constituentOf qm:M2,
        qm:TheTransitionalModalities ;
    qm:enablesConversionOf [ a qm:AbstractInternalExperience ] ;
    qm:facilitatesEmbodimentOf [ a qm:MentalPhysicalInterface ] ;
    qm:hasCapacityFor [ a qm:EmotionalOpenness ],
        [ a qm:PrincipleReceptivity ] ;
    qm:orchestrates [ a qm:ProtoImpulse ] ;
    qm:receivesInputFrom qm:Pd4,
        qm:Pd5,
        qm:Pd6 .

qm:PrimeModality a owl:Class ;
    rdfs:label "Prime Modality (M1)",
        "Prime Modality (M1)"@en,
        "X. Prime Modality (M1)"@en ;
...
qm:PsychoTranspersonalDimension a owl:Class ;
    rdfs:label "Psycho-Transpersonal Dimension (Pd10)",
        "Psycho-Transpersonal Dimension (Pd10)"@en ;
    rdfs:comment "The interface with manifested reality, concrete action, and the experience of the physical world.",
        "Pd10: This passive dimension acts as a conduit for collective influence and external resonance, allowing the final state of M2 to be expressed unless negated by the Psycho-Volitional dimension (Pd1)."@en,
...
qm:PsychologicalPhenomenon a owl:Class ;
...
qm:SecondhandExperience a owl:Class ;
...
qm:isAppliedTo a owl:ObjectProperty ;
...
qm:ChallengesAndLimitationsCategory a owl:Class ;
    rdfs:label "Challenges and Limitations"@en ;
    rdfs:comment "Acknowledged difficulties or boundaries in the theory or application of Quantum Mindfulness."@en .

qm:ObservationValence a owl:Class,
        owl:NamedIndividual ;
    rdfs:label "Observation Valence (Valence(Ψ))",
        "Observation Valence (Valence(Ψ))"@en ;
    rdfs:comment "The subjective emotional coloring or the numeric rating of positivity or negativity that the mind assigns to a specific observation. This valence is a crucial output of the perceptual and interpretive process and provides the 'Impact of the Now' component for the Cognitive Appraisal."@en ;
    rdfs:subClassOf qm:ObservationComponentsCategory .

qm:Pd7 a owl:NamedIndividual,
        qm:PsychoMotivationalDimension ;
    rdfs:label "The Psycho-Motivational Dimension (Pd7)"@en ;
    qm:constituentOf qm:M2,
        qm:TheTransitionalModalities ;
    qm:embodies [ a qm:PsychoMotivationalMomentum ] ;
    qm:hasKabbalisticCorrespondence qm:Netzach ;
    qm:isSupportedByMechanism [ a qm:CognitiveAnchoring ],
        [ a qm:VolitionalContinuity ] ;
    qm:translatesValuesInto [ a qm:SustainedAction ] .

qm:PerceptualShapingTechnique a owl:Class ;
...
qm:ProcessingMechanism a owl:Class ;
    rdfs:label "Processing Mechanism"@en ;
    rdfs:subClassOf qm:Phenomenon .

qm:PsychoEmpathicDimension a owl:Class ;
    rdfs:label "Psycho-Empathic Dimension (Pd4)",
        "Psycho-Empathic Dimension (Pd4)"@en ;
    rdfs:comment "The dimension of expansive emotional connection, capacity for altruism, and the compassionate drive for growth and connection with others.",
        "An expansive cognitive state promoting creative association, cognitive flexibility, and openness; the foundation for empathy and compassion. It is the foundational source of love and compassion, driving intersubjective resonance."@en,
...
qm:hasPractice a owl:ObjectProperty ;
...
qm:CognitiveAppraisalComponentsCategory a owl:Class ;
...
qm:PersonalTendency a owl:Class ;
    rdfs:label "Personal Tendency (w)",
        "Personal Tendency (w)"@en,
        "X. Personal Tendency (w)"@en ;
...
qm:PsychodynamicCollapse a owl:Class ;
    ...
    skos:altLabel "Cognitive Collapse",
        "Wave Function Collapse",
        "Cognitive Solidification"@en,
        "Present Collapse of Perception"@en .

qm:PsychodynamicWaveCollapse a owl:Class ;
...
qm:PsychologicalDysfunctionAndImbalance a owl:Class ;
...
qm:Pd1 a owl:NamedIndividual,
        qm:PsychoVolitionalDimension,
        qm:PsychodynamicDimension ;
    rdfs:label "Psycho-Volitional Dimension (Pd1)"@en,
        "The Psycho-Volitional Dimension (Pd1)"@en ;
    qm:constituentOf qm:M1 ;
    qm:dissolves [ a qm:PerceivedLimitation ] ;
    qm:embodies [ a qm:PurePotentiality ] ;
    qm:hasKabbalisticCorrespondence qm:Keter ;
    qm:hasPrimacyOver qm:Pd2,
        qm:Pd3 ;
    qm:isSourceOf [ a qm:Will ] ;
    qm:providesFoundationFor qm:Pd2,
        qm:Pd3 .

qm:Pd2 a owl:NamedIndividual,
    ...
    qm:dependsOn qm:Pd1 ;
    qm:follows qm:Pd1 ;
    qm:hasKabbalisticCorrespondence qm:Chokhmah ;
    qm:operatesThrough [ a qm:IntuitiveCognition ] ;
    qm:progressesTo qm:Pd3 .

qm:Pd3 a owl:NamedIndividual,
    ...
    qm:constituentOf qm:M1 ;
    qm:follows qm:Pd2 ;
    qm:harmonizes [ a qm:VolitionalImpulse ],
        [ ] ;
    qm:hasCapacityFor [ a qm:ParadoxTolerance ] ;
    qm:hasKabbalisticCorrespondence qm:Binah ;
    qm:isLocusOf [ a qm:IntentionalCollapse ] ;
    qm:operatesThrough [ a qm:AnalyticalReasoning ] ;
    qm:providesFoundationFor [ a qm:SecondaryModality ] ;
    qm:receivesInputFrom qm:Pd2 .

qm:Perception_Concept a owl:Class ;
    rdfs:label "Perception"@en ;
    rdfs:comment "The process of interpreting and understanding sensory information and internal stimuli, leading to a subjective experience of reality."@en ;
    rdfs:subClassOf qm:CoreConceptsCategory .

qm:PsychologicalDisharmony a owl:Class ;
...
qm:UnresolvedSuperpositionConsequence a owl:Class ;
...
qm:Contemplation a owl:Class,
        owl:NamedIndividual ;
    rdfs:comment "An active, deliberate cognitive process involving sustained, rigorous mental work to transform potential into Structured Understanding. It is integral to conscious awareness and instrumental in processing all conscious experience."@en,
...
qm:FormalArchitectureCategory a owl:Class ;
    rdfs:label "Formal Architecture"@en ;
    rdfs:comment "A conceptual grouping for the formal, structured model of psychodynamic processes."@en .

qm:M2 a owl:NamedIndividual,
        qm:SecondaryModality ;
    qm:composedOf qm:Pd7,
        qm:Pd8,
        qm:Pd9 ;
...
qm:ObservationComponentsCategory a owl:Class ;
...
qm:PsychoConceptiveDimension a owl:Class ;
    rdfs:label "Psycho-Conceptive Dimension (Pd2)",
        "Psycho-Conceptive Dimension (Pd2)"@en ;
    rdfs:comment "The capacity for rapid, pre-verbal insight, generative ideation, and the initial formation of raw concepts.",
        "A dynamic, highly intuitive cognitive function that facilitates spontaneous insight and pattern recognition. It represents the psyche’s initial creative act, where abstract, unformed potential begins to coalesce into nascent concepts, functioning as the subconscious wellspring of wisdom and intellect."@en,
...
qm:PsychoReceptiveDimension a owl:Class ;
    rdfs:label "Psycho-Receptive Dimension (Pd8)",
        "Psycho-Receptive Dimension (Pd8)"@en ;
    rdfs:comment "The capacity for intellectual assimilation, structured communication, and the formal expression or reception of thought.",
        "A sophisticated cognitive self-correction mechanism for refining perception, reassessing beliefs, and enhancing precision through feedback integration. It functions as an essential cognitive self-correction mechanism, continuously refining perception and prompting reassessment of established beliefs."@en,
...
qm:isModulatedBy a owl:ObjectProperty ;
...
qm:CognitiveMechanism a owl:Class ;
...
qm:EpistemologicalChallenges a owl:Class ;
...
qm:PsychoFoundationalDimension a owl:Class ;
    rdfs:label "Psycho-Foundational Dimension (Pd9)",
        "Psycho-Foundational Dimension (Pd9)"@en ;
    rdfs:comment "The deepest layers of the subconscious, primal drives, energetic libido, and the fundamental energetic basis that structures personality.",
        "Pd9: The dimension of familiarity, values, belonging, and moral grounding."@en,
...
qm:PsychoProtectiveDimension a owl:Class ;
    rdfs:label "Psycho-Protective Dimension (Pd5)",
        "Psycho-Protective Dimension (Pd5)"@en ;
    rdfs:comment "The ability for setting and maintaining boundaries, exercising self-discipline, and containing psychic energy or impulses.",
        "Cognitive mechanisms regulating decision-making and maintaining psychological coherence through inhibition, boundary formation, and selective focus. It embodies principles of measure, limit, and restraint."@en,
...
qm:CognitiveStrainAndDysfunction a owl:Class ;
...
qm:CollapseInfluencePractice a owl:Class ;
...
qm:PsychoMeditativeDimension a owl:Class ;
    rdfs:label "Psycho-Meditative Dimension (Pd3)",
        "Psycho-Meditative Dimension (Pd3)"@en ;
    rdfs:comment "The faculty for systematic thought, logical construction, and the analytical organization of ideas into coherent understanding.",
        "Pd3: Encompasses cognition, reflection, and interpretive processing, facilitating learning and integrative understanding. It assists in analyzing situations from new perspectives during active reframing."@en,
...
qm:SecondaryModality a owl:Class ;
    rdfs:label "Secondary Modality (M2)",
        "Secondary Modality (M2)"@en,
        "X. Secondary Modality (M2)"@en ;
...
qm:TherapeuticStrategy a owl:Class ;
    rdfs:label "Therapeutic Strategy"@en ;
...
qm:targets a owl:ObjectProperty ;
...
qm:CognitiveCapacity a owl:Class ;
    rdfs:label "Cognitive Capacity"@en ;
    rdfs:subClassOf qm:GoalsCategory .

qm:DimensionalActivationInfluencesCategory a owl:Class ;
    ...
    rdfs:subClassOf qm:DimensionalActivation .

qm:InfluentialFactor a owl:Class ;
    rdfs:label "Influential Factor"@en ;
...
qm:PsychoMotivationalDimension a owl:Class ;
    rdfs:label "Psycho-Motivational Dimension (Pd7)",
        "Psycho-Motivational Dimension (Pd7)"@en ;
    rdfs:comment "The wellspring of instinctual drives, persistent willpower, and the energetic force that propels action and perseverance.",
        "Forward-projecting cognitive energy responsible for sustaining motivation, fostering cognitive endurance, and enabling long-term pattern recognition for achieving goals across extended time periods."@en,
...
qm:isDeterminedBy a owl:ObjectProperty ;
...
qm:AdvancedPracticesAndMethodologiesCategory a owl:Class ;
...
qm:PsychoAestheticDimension a owl:Class ;
    rdfs:label "Psycho-Aesthetic Dimension (Pd6)",
        "Psycho-Aesthetic Dimension (Pd6)"@en ;
    rdfs:comment "The central integrating force of the psyche, balancing internal experiences with external reality, fostering harmony and authenticity of the self.",
        "A crucial balancing cognitive mechanism that harmonizes seemingly opposing forces within the psyche, establishing harmonious integration between opposing psychological forces. It functions as an integration hub, specializing in harmonious synthesis among opposing energies."@en,
...
qm:PsychoVolitionalDimension a owl:Class ;
    rdfs:label "Psycho-Volitional Dimension (Pd1)",
        "Psycho-Volitional Dimension (Pd1)"@en ;
    rdfs:comment "Represents the fundamental origin of psychic energy, primal intentionality, and the source of consciousness.",
...
qm:hasInterdimensionalConnection a owl:ObjectProperty ;
...
qm:Uncategorized a owl:Class .

qm:AdvancedPractice a owl:Class ;
    rdfs:label "Advanced Practice"@en ;
    rdfs:comment "A structured methodology within Quantum Mindfulness for engaging directly with the generative systems of consciousness, enabling a more sophisticated and agentic relationship with one's internal experience."@en ;
    rdfs:subClassOf qm:CoreConceptsCategory .

qm:PsychodynamicDimension a owl:Class ;
    rdfs:label "Psychodynamic Dimension (Pdj)",
        "Psychodynamic Dimension Category",
        "Psychodynamic Dimension (Pdj)"@en,
        "X. Psychodynamic Dimension (Pdj)"@en ;
    rdfs:comment "A conceptual category representing various aspects of the psyche based on psychodynamic theory.",
        "The elemental 'quanta' or irreducible building blocks of mental and emotional life. They are conceptualized as fundamental energetic substrates from which cognitions, emotions, and motivations emerge, forming the substance of conscious awareness and the structural foundation of personality organization."@en,
